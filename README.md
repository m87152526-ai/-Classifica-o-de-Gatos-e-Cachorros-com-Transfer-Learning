...
O objetivo é demonstrar o poder da reutilização de redes neurais retreinadas, reduzindo o tempo de treinamento e melhorando a precisão em um conjunto de dados pequeno. 
